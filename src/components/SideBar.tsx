...
function App() {
    ...
    const classManager = ({ isActive }: { isActive: boolean }) => {
        ...
        <nav className='h-full bg-gray-800 w-72 flex flex-col items-center ' >
            ...
            <div className='grow w-full h-full flex items-center ' >
                ...
                <div className='grow h-full bg-[#393d42] ' >
                    ...
                    <NavLink to='notifications' className={classManager} >
                        <div className='link' >
                    ...
                    <NavLink to='summary' className={classManager} >
                        <div className='link' >
                    ...
                    <NavLink to='/' className={classManager}>
                        <div className='link' >
                    ...
                    <NavLink to='engage' className={classManager} >
                        <div className='link' >
                    ...
                    <NavLink to='listen' className={classManager}>
                        <div className='link' >
                    ...
                    <NavLink to='report' className={classManager}>
                        <div className='link' >
